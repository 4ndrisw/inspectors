...
<?php
    ...
    $inspectors = $CI->inspectors_model->get_project_not_inspectord(get_staff_user_id());
?>

<div class="widget" id="widget-<?php echo create_widget_id(); ?>" data-name="<?php echo _l('project_not_inspectord'); ?>">
    <?php if(staff_can('view', 'inspectors') || staff_can('view_own', 'inspectors')) { ?>
    <div class="panel_s inspectors-expiring">
        <div class="panel-body padding-10">
            <p class="padding-5"><?php echo _l('project_not_inspectord'); ?></p>
                ...
                <div class="table-vertical-scroll">
                    ...
                    <table id="widget-<?php echo create_widget_id(); ?>" class="table dt-table" data-order-col="2" data-order-type="desc">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th class="<?php echo (isset($client) ? 'not_visible' : ''); ?>"><?php echo _l('inspector_list_project'); ?></th>
                            ...
                            <?php foreach ($inspectors as $inspector) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php echo '<a href="' . admin_url("projects/view/" . $inspector["id"]) . '">' . $inspector['name'] . '</a>'; ?>
                                    </td>
                                    <td>
            ...
            <?php } else { ?>
                <div class="text-center padding-5">
                    ...
                    <h4><?php echo _l('no_project_not_inspectord',["7"]) ; ?> </h4>
                </div>
            <?php } ?>
        </div>
    </div>
