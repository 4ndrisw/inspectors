...
class Inspector_pdf extends App_pdf
{
    protected $inspector;
    ...
    public function __construct($inspector, $tag = '')
    {
        ...
        $this->SetTitle($this->inspector_number);
    }
    ...
    {
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_inspectorpdf.php';
        $actualPath = module_views_path('inspectors','themes/' . active_clients_theme() . '/views/inspectors/inspectorpdf.php');
